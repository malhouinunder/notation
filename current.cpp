...
string AnyBaseInt::Convert_to_Decimal(string &buf, int base, string alphabet, bool Negative) //преобразование в десятичное число, если уже десятичное, то просто возвращается изначальная строка 
{
	if (Negative)
	{
